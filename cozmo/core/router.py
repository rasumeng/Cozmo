...
class ToolRouter:
    CATEGORIES = {
        ...
        "git_commit": {
            ...
            "keywords": ["commit this", "commit changes", "commit the", "stage", "add"],
        ...
        "filesystem": {
            "keywords": ["file", "read", "write", "directory", "folder", "delete", "move", "copy", "mkdir", "list", "search files", "tree", "edit", "create", "rename", "open", "save", "path"],
        ...
        "web": {
            "keywords": ["search", "find", "lookup", "url", "fetch", "scrape", "browse", "http", "website", "web", "google", "online", "internet"],
            "tools": ["web_search", "web_search_pipeline", "fetch_url", "web_fetch"],
        },
        "code": {
            "keywords": ["run", "execute", "python", "bash", "shell", "compile", "test", "pip", "install", "script", "code", "calculator", "math", "calculate", "program"],
